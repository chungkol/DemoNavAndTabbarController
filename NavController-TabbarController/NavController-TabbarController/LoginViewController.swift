...
class LoginViewController: BaseViewController {
    ...
    @IBAction func signUpAction(sender: AnyObject) {
        let sigupVC = storyboard?.instantiateViewControllerWithIdentifier("SignUpVC") as! SignUpViewController
        navigationController?.pushViewController(sigupVC, animated: true)
    }
